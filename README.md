...
> Repositório criado como parte da **Formação JavaScript para Back-end** da [Alura](https://www.alura.com.br/), com foco em programação Orientada a Objetos.

## **📚 Curso relacionado**

Este projeto faz parte do módulo:  
**👉 Programação Orientada a Objetos – JavaScript para Back-end**
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/bamarcheti/javascript-oo
   cd javascript-oo
   npm install
   ```
